...
select_brand.select_by_visible_text('Mazda')
...
select_start_date.select_by_visible_text('2014')
...
# Save
df.to_csv(f'Mazda_{datetime.today().date()}.csv', index=False)