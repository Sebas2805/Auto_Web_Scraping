...
select_filters_element = WebDriverWait(driver, 10).until(
    EC.presence_of_element_located((By.XPATH, '//*[@id="searchform"]/div/div[1]/table/tbody/tr[4]/td[2]/select'))
)

select_brand = Select(select_filters_element)
select_brand.select_by_visible_text('Eléctrico')

select_price_filter = WebDriverWait(driver, 10).until(
    EC.presence_of_element_located((By.XPATH, '//*[@id="searchform"]/div/div[2]/table/tbody/tr[4]/td[2]/select'))
)

select_priceLimit = Select(select_price_filter)
select_priceLimit.select_by_visible_text('15,000,000')
